// Uncomment this to enable shorthand operator and class macros
/* 
...
#macro Throttle			wx_throttle
#macro Debounce			wx_debounce
#macro SwitchMap		wx_switchmap
